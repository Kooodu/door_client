<template>
   <div class="site-content__left">
      ...
      <a class="red_block w-inline-block">
...
export default {
   ...
   methods: {
      ...
      filterItems() {
         ...
         this.$router.push({ path: `/fabricator/${this.$route.params.fabricatorId}/`, query: query_params, replace: true })
      },
      nullFilters() {

                        ...
                        <div class="site-content__right">
                            <main class="site-main">
                                <div class="site-main__inner">
                                    <div style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 50px 150px;" class="stock__con">
                                        <router-link style="text-decoration: none;" to="/stocks/item-1" class="stock">
                                            <img style="width: 365px; height: 193px; border-radius: 10px;" src="./../../../assets/299_442.jpg" class="stock__img">
                                            <div style="margin: 19px 0px 0px 0px; line-height: 27px; color: #262020; font-weight: 700; font-size: 100%;" class="stock__title">купон1</div>
                                            <div style="margin: 16px 0px 0px 0px; line-height: 23px; color: #7c7474; font-weight: 500; font-size: 15px;" class="stock__desc">купон1</div>
                                        </router-link>
                                        <router-link style="text-decoration: none;" to="/stocks/item-2" class="stock">
                                            <img style="width: 365px; height: 193px; border-radius: 10px;" src="./../../../assets/299_442.jpg" class="stock__img">
                                            <div style="margin: 19px 0px 0px 0px; line-height: 27px; color: #262020; font-weight: 700; font-size: 100%;" class="stock__title">купон2</div>
                                            <div style="margin: 16px 0px 0px 0px; line-height: 23px; color: #7c7474; font-weight: 500; font-size: 15px;" class="stock__desc">купон2</div>
                                        </router-link>
                                        <router-link style="text-decoration: none;" to="/stocks/item-3" class="stock">
                                            <img style="width: 365px; height: 193px; border-radius: 10px;" src="./../../../assets/299_442.jpg" class="stock__img">
                                            <div style="margin: 19px 0px 0px 0px; line-height: 27px; color: #262020; font-weight: 700; font-size: 100%;" class="stock__title">купон3</div>
                                            <div style="margin: 16px 0px 0px 0px; line-height: 23px; color: #7c7474; font-weight: 500; font-size: 15px;" class="stock__desc">купон3</div>
                                        </router-link>
                                        <router-link style="text-decoration: none;" to="/stocks/item-4" class="stock">
                                            <img style="width: 365px; height: 193px; border-radius: 10px;" src="./../../../assets/299_442.jpg" class="stock__img">
                                            <div style="margin: 19px 0px 0px 0px; line-height: 27px; color: #262020; font-weight: 700; font-size: 100%;" class="stock__title">купон4</div>
                                            <div style="margin: 16px 0px 0px 0px; line-height: 23px; color: #7c7474; font-weight: 500; font-size: 15px;" class="stock__desc">купон4</div>
                                        </router-link>
                                    </div>
                                </div>
                            </main>
